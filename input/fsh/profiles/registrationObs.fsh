...
Title: "Example of client Registration observation"
Description: "Example of a client registration observation"

* status = #final
* category = http://terminology.hl7.org/CodeSystem/observation-category#social-history
* code = $SCT#123456 "NEIR Registration Observations" // Replace with actual code when created
* subject = Reference(Patient/NEIRPatientExample) // Replace with actual patient reference
